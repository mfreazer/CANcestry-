...
| Version | Date | Change |
|---|---|---|
| 0.2.4 | 2026-09-20 | N2 audit: pin the hold-up build/execution to CoSimulation, test the mode gate and real-FMU interface, and retain FMPy TCL1 only for the bounded OR-001 output-detection argument. No FMPy gap waiver or pulse promotion. |
