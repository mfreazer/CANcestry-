...
| Requirement boundary | `SW-FR-HIL-001..006`, `SW-FR-BM-005..006`, `SW-FR-GOV-006` |
...
### 3.1 Bus-Off recovery (`HIL-BUSOFF-001`)
...
### 3.2 Electrical noise / CRC rejection (`HIL-CRC-001`)
...
## 4. Target/QEMU completion procedure
